...
export class TercoRezarComponent implements OnInit {
  ...
  public getOracaoVetor() {
    var oracoes: number[][] = [
      ...
      [6, 21, 1, 0], [6, 6, 1, 1], [6, 6, 1, 1], [6, 6, 1, 1], [6, 6, 1, 1], [6, 6, 1, 1], [6, 6, 1, 1], [6, 6, 1, 1], [6, 6, 1, 1], [6, 6, 1, 1], [6, 6, 1, 1], [8, 7, 1, 0], [8, 8, 1, 0],
      [6, 22, 2, 0], [6, 6, 2, 1], [6, 6, 2, 1], [6, 6, 2, 1], [6, 6, 2, 1], [6, 6, 2, 1], [6, 6, 2, 1], [6, 6, 2, 1], [6, 6, 2, 1], [6, 6, 2, 1], [6, 6, 2, 1], [8, 7, 2, 2], [8, 8, 2, 0],
      [6, 23, 3, 0], [6, 6, 3, 1], [6, 6, 3, 1], [6, 6, 3, 1], [6, 6, 3, 1], [6, 6, 3, 1], [6, 6, 3, 1], [6, 6, 3, 1], [6, 6, 3, 1], [6, 6, 3, 1], [6, 6, 3, 1], [8, 7, 3, 2], [8, 8, 3, 0],
      [6, 24, 4, 0], [6, 6, 4, 1], [6, 6, 4, 1], [6, 6, 4, 1], [6, 6, 4, 1], [6, 6, 4, 1], [6, 6, 4, 1], [6, 6, 4, 1], [6, 6, 4, 1], [6, 6, 4, 1], [6, 6, 4, 1], [8, 7, 4, 2], [8, 8, 4, 0],
      [6, 25, 5, 0], [6, 6, 5, 1], [6, 6, 5, 1], [6, 6, 5, 1], [6, 6, 5, 1], [6, 6, 5, 1], [6, 6, 5, 1], [6, 6, 5, 1], [6, 6, 5, 1], [6, 6, 5, 1], [6, 6, 5, 1], [8, 7, 5, 2], [8, 8, 5, 0],
      [7, 9, 0, 0], [7, 10, 0, 0]
    ];
    return oracoes;
  }
